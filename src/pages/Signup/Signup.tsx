...
const Signup: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] font-poppins">
      {/* Header */}
      <header 
        className="bg-white shadow-[0_4px_16px_0_#00000026] py-4 flex justify-center mb-1">
        ...
        <div className="md:w-1/2 w-full flex items-center justify-start px-6 py-8">
          ...
          >
            <Form className="w-full max-w-md">
              ...
              <div className="relative mb-4">
                <FormInput name="password" label="Enter your Password" type={showPassword ? 'text' : 'password'} />
                <div
              ...
              {/* Confirm Password */}
              <div className="relative mb-4">
                <FormInput name="confirmPassword" label="Confirm Password" type={showConfirm ? 'text' : 'password'} />
                <div
                  className="absolute right-3 top-[52px] cursor-pointer"
         ...
         <img src="/images/check.svg" alt="Check Icon" className="w-4 h-4 mt-1" />
          <p className="text-[14px] font-[700] font-poppins text-[#32405499]">
           By Creating an account, I agree to our <a href="#" className="text-[#0463CA]">Terms of use</a> and policy
      </p>
    </div>
    <div className="flex items-start gap-2">
      ...
      <button 
        className="bg-[#BBCACA] rounded-[24px] 
        w-full md:w-[158px] md:h-[59px] py-3 
       text-[#324054] font-[500] text-[18px] cursor-pointer font-poppins">
        Sign Up
      </button>
  
      <p className="text-[#32405499] text-[14px] md:text-[16px] font-[500] text-center md:text-left">
       Already have an account? <Link to="/login" className="text-[#0463CA]">Login</Link>
      </p>
     </div>
     </Form>
      </Formik>
